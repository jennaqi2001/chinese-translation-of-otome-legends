...
init python:
    if persistent.escape:
        ...
        config.quit_action = Jump("complete_restart")
    else:
        config.quit_action = Quit(confirm=False)
...
init python:
    if persistent.naomi:
        persistent.menu_music = "audio/warppedmenu.mp3"
    else:
        persistent.menu_music = "audio/menutheme.mp3"
...
#define gui.text_font = "fonts/Chinese_Font.ttf"

## The font used for character names.
define gui.name_text_font = "fonts/Bistroblock.ttf"
##DejaVuSans.ttf

## The font used for out-of-game text.
define gui.interface_text_font = "fonts/Bryndan_Write.ttf"
#define gui.interface_text_font = "fonts/Chinese_Font.ttf"
